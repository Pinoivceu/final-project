/*
  ...
  - The primary key for the `harvests` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE "tasks" ALTER COLUMN "landId" SET DATA TYPE TEXT;
